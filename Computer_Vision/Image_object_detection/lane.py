...
resized_img1 = cv.resize(img1, (desired_width, desired_height))
resized_img2 = cv.resize(img2, (desired_width, desired_height))

cv.imshow('img1', resized_img1)
cv.imshow('img2', resized_img2)
